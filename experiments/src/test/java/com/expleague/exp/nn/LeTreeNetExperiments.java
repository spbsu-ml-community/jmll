...
public class LeTreeNetExperiments {
  private static final Path PATH_TO_LENET_MODEL = Paths.get("/Users/solar/Downloads/lenet.nn");
  ...
  private static NetworkBuilder<Vec>.Network createConvLeNet() {
  ...
  private static NetworkBuilder<Vec>.Network createMobileNet() {
    final NetworkBuilder<Vec>.Network network =
        new NetworkBuilder<>(new ConstSizeInput3D(heightIn, widthIn, 1))
            .append(ConvLayerBuilder.create()
                .channels(16)
  ...
  public void trainOnLeNetFeatures() {
    final NetworkBuilder<Vec>.Network nn = createConvLeNet();
    nn.loadInitWeights(PATH_TO_LENET_MODEL, 4);
  ...
  public void trainMobileNetFromScratch() {
    final NetworkBuilder<Vec>.Network nn = createMobileNet();
