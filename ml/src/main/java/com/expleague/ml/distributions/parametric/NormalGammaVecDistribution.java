...
public interface NormalGammaVecDistribution extends DynamicRandomVec<NormalGammaDistribution> {
  ...
  NormalGammaVecDistribution update(final int idx, final double mu, final double lambda, final double alpha, final double beta);

  default NormalGammaVecDistribution update(final int idx, final NormalGammaDistribution distribution) {
