...
public class GradFacFilterMulticlass implements VecOptimization<L2> {
  ...
  public GradFacFilterMulticlass(final VecOptimization<L2> inner, final Factorization matrixDecomposition, final Class<? extends L2> local) {
    this(inner, matrixDecomposition, local, false);
  }

  public GradFacFilterMulticlass(final VecOptimization<L2> inner, final Factorization matrixDecomposition, final Class<? extends L2> local, final boolean printErrors) {
    this.inner = inner;
