...
// * User: noxoomo
// */
//public class RandomnessAwareRegion extends RandomFunc.Stub<BinOptimizedRandomnessPolicy> implements RandomFunc<BinOptimizedRandomnessPolicy>, Func {
...
//
//  public int dim() {
//    return splits[0].featureBinarization().featureBinarization().dim();
//  }
//
...
//      features[depth] = splits[depth].featureBinarization().featureBinarization().computeAll(dataSet);
...
//        int idx = 0;
//        for (int i = 0; i < splits.length; ++i) {
//          RandomVariable rv = splits[i].featureBinarization().featureBinarization().compute(feature);
