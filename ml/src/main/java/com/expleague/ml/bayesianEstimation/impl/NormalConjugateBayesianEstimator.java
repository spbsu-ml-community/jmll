...
public class NormalConjugateBayesianEstimator implements ConjugateBayesianEstimator<NormalGammaDistribution> {

  @Override
  public NormalGammaDistribution clone(final NormalGammaDistribution dist) {
    return new NormalGammaDistributionImpl(dist.mu(), dist.lambda(), dist.alpha(), dist.beta());
  }
