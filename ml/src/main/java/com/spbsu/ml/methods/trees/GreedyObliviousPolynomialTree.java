...
/*
    ...
    Vec calculateDiverativeVec(VecDataSet dataSet, WeightedLoss<L2> loss, List<BFGrid.BinaryFeature> features) {
    ...
    public ContinousObliviousTree fit(VecDataSet ds, WeightedLoss<L2> loss) {
