...
//    protected VecDataSet learn;
//    protected VecDataSet test;
//
...
//      };
//
//      Vec learnPredicted = model.bestClassAll(DataTools.data(learn));
...
//        };
//        Vec testPredicted = model.bestClassAll(DataTools.data(test));
...
//    @Override
//    protected void setUp() throws Exception {
//      FEATURES = "./jmll/ml/src/test/data/lines.txt.gz";
//
//      depth = 4;
//      minEntries = 450;
//      weakStep = 1.5;
...
//      final VecDataSet learn = MCTools.loadRegressionAsMC("./ml/tests/data/lines.txt.gz", classCount, borders);
//      final VecDataSet test = MCTools.loadRegressionAsMC("./ml/tests/data/featuresTest.txt.gz", classCount, borders);
...
//          if ((index + 1) % 20 == 0) {
//            double lvalue = learnLoss.value(partial.transAll(DataTools.data(learn)));
//            double tvalue = testLoss.value(partial.transAll(DataTools.data(test)));
...
//      }
//
//      learnTree.fill(new ChangedTarget((RegressionVecDataSet) learn, mappedLearnTarget));
//      testTree.fill(new ChangedTarget((RegressionVecDataSet) test, mappedTestTarget));
//
...
//        if (childModel != null) {
//          final VecDataSet learnNodeDSForChild = learnNode.createDSForChild(label);
//          final VecDataSet testNodeDSForChild = testNode.createDSForChild(label);
//          final Mx learnChildProbs = childModel.probsAll(DataTools.data(learnNodeDSForChild));
//          final Mx testChildProbs = childModel.probsAll(DataTools.data(testNodeDSForChild));
