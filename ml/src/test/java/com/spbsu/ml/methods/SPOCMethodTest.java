...
//      final Vec predict = model.bestClassAll(((VecDataSet) ds).data());
...
//      final MLLLogit learnLoss = learn.target(MLLLogit.class);
...
//      final Mx similarityMatrix = MCTools.createSimilarityMatrix(learn.vecData(), learn.target(MLLLogit.class));
...
//    public void setUp() throws Exception {
//      super.setUp();
//      final VecDataSet fullds = DataTools.loadFromSparseFeaturesTxt("./ml/tests/data/multiclass/ds_letter/letter.libfm");
...
//      final VecDataSet dataSet = MCTools.normalizeClasses(learn);
