...
//    boosting.addProgressHandler(modelPrinter);
    ...
    public void testCOTBoost() {
        final GradientBoosting boosting = new GradientBoosting(new GreedyContinuesObliviousSoftBondariesRegressionTree(new FastRandom(), learn, GridTools.medianGrid(learn, 32), 3), 2000, 0.005, rng);
        final ProgressHandler counter = new ProgressHandler() {
            int index = 0;
