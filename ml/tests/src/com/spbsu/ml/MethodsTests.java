...
//    boosting.addListener(modelPrinter);
    ...
    public void testPCAOTBoost() {
        ...
        final GradientBoosting<L2> boosting = new GradientBoosting<L2>(new BootstrapOptimization(new GreedyObliviousTree(GridTools.medianGrid(myLearn, 32), 6), rng), 2000, 0.005);
        ...
        //boosting.addListener(qualityCalcer);
//    boosting.addListener(modelPrinter);
        boosting.fit(myLearn, new SatL2(myLearn.target()));
    }
